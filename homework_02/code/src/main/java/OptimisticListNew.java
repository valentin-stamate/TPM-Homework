...
public class OptimisticListNew<T> {
    ...
    public boolean add(T item) {
        int currentVersion = atomicInteger.get();
        ...
        while (true) {
            ...
            try {
                if (validate(pred, current, currentVersion)) {
    ...
    private boolean validate(Node pred, Node current, int oldVersion) {
        if (oldVersion == atomicInteger.get()) {
            return true;
        }
